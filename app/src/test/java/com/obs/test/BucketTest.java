...
//        BucketCustomDomainInfo bucketCustomDomainInfo = obsClient.getBucketCustomDomain("shenqing-oms-test-003");
        ...
        HeaderResponse response = obsClient.setBucketCustomDomain("testBucket", "test.example.com");
    ...
    public void test_delete_bucket_customdomain() {
        ...
        HeaderResponse response = obsClient.deleteBucketCustomDomain("testBucket", "test.example.com");
        System.out.println(response.toString());
    }
