...
public class XmlResponsesSaxParserTest extends BaseObjectTest {
    ...
    public void test_BucketEncryptionHandler() {
        ...
        String xml = new StringBuilder("<ServerSideEncryptionConfiguration")
                .append("<Rule>")
    ...
    public void test_BucketStoragePolicyHandler() {
        ...
        String xml = new StringBuilder("<GetBucketStorageInfoResult>")
                .append("<Size>10</Size>")
    ...
    public void test_BucketNotificationConfigurationHandler() {
        ...
        String xml = new StringBuilder("<NotificationConfiguration>")
    ...
    public void test_BucketReplicationConfigurationHandler() {
        ...
        String xml = new StringBuilder("<ReplicationConfiguration>")
                .append("<Rule>")
                .append("<ID>Rule-1</ID>")
